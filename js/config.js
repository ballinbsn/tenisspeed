...
/* ==========================================================================
   ...
   é uma imagem única.
   ========================================================================== */
/* 21/09/2026: selo desativado por risco de política do Google Ads (é um selo do Mercado Livre;
   só pode voltar se a loja for de fato a vendedora com esse selo). Para reativar:
   TRUST_BADGE_IMAGE = "assets/landing/lider-platinum.png". */
const TRUST_BADGE_IMAGE = null;
